...
public class CaptchaCryptoProvider : ICaptchaCryptoProvider
{
    ...
    public string? Decrypt(string inputText, bool ecb = false)
    {
        ...
        var bytes = ecb ? DecryptItEcb(inputBytes) : DecryptIt(inputBytes);
    ...
    public string Encrypt(string inputText, bool ecb = false)
    {
        ...
        var bytes = ecb ? EncryptItEcb(inputBytes) : EncryptIt(inputBytes);
    ...
    private byte[] EncryptItEcb(byte[] data)
    {
        using var des = new TripleDESCryptoServiceProvider
        {
            Key = _keyBytes,
    ...
    private byte[] DecryptItEcb(byte[] data)
    {
        using var des = new TripleDESCryptoServiceProvider
        {
            Key = _keyBytes,
